 ...
 */
const useQueryParams = <TValue extends string[]>(
  key: string,
  options: UseQueryParamsOptions<TValue> = {},
) => {
  ...
  return [initialisedRef.current ? params.getAll(key) : options.initialValue, setParam] as [
    TValue,
